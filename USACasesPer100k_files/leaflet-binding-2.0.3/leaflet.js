...
if (typeof _leaflet2.default.Icon.Default.imagePath === "undefined") {
  ...
  /*
  if (L.Browser.retina) {
    L.Icon.Default.prototype.options.iconUrl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAABSCAYAAAAWy4frAAAPiElEQVR42t1bCVCU5xkmbabtZJJOO+l0mhgT0yQe0WXZgz2570NB8I6J6UzaTBoORRFEruVGDhk(this, DataFrame);
...
// copy ";
  } else {
    L.Icon.Default.prototype.options.iconUrl = "data:image/png;base64,";
  }
  */
...
var _layerManager2 = _interopRequireDefault(_layerManager// Store some state in the map object
        map.leafletr = {
  ...
  factory: function factory(el, width, height) {
    ...
    return {
      ...
      doRenderValue: function doRenderValue(data, map) {
        ...
        // zoomed to map elements.
        function needsZoom() {
          re// Store some state in the map object
        map.leafletr = {
          // Has the map ever rendered successfully?
          hasRendered: false,
          // Data to be rendered when resize is called with area != 0
          ...
          var handleFilter = function handleFilter(e) {
            if (!e.value) {
              ...
              for (var _i2 = 0; _i2 < _groupKeys.length; _i2++) {
                ...
                _this._setVisibility(_layerInfo2, selectedKeys[_groupe>: {<stamp>: layer}}
    this._byCategory = {};
    // {<categoryName_layerId>: layer}
    this._byLayerId = {};
    // {<stamp>: {
          ...
          var handleFilter = function handleFilter(e) {
            if (!e.value) {
              ...
              for (var _i2 = 0; _i2 < _groupKeys.length; _i2++) {
                var _key = _groupKeys[_i2];
                var _layerInfo2 = _this._byStamp[ctg[_key]];
                _this._setVisibility(_layerInfo2, selectedKeys[_group    _jquery2.default.each((0, _util.asArray)(layerIds), function (i, layerId) {
...
methods.addMarkers = function (lat, lng, icon, layerId, group, options, popup, popupOptions, clusterOptions, clusterId, label, labelOptions, crosstalkOptions) {
  var icondelete ctGroup[layerInfo.ctKey];
          } else {
            layersForKey.splice(idx, 1);
          }
        }
  ...
  var _loop3 = function _loop3(i) {
    (function () {
      ...
      if (!_jquery2.default.isEmptyObject(layer)) {
        var thisId = df.get(i, "layerId");
        var thisGroup = df.get(i, "group");
        this.layerManager.addLayer(layer, category, thisId, thisGroup, df.get(i, "ctGroup", true), df.g};
  ...
  var _loop3 = function _loop3(i) {
    (function () {
      ...
      if (!_jquery2.default.isEmptyObject(layer)) {
        var thisId = df.get(i, "layerId");
        var thisGroup = df.get(i, "group");
        this.layerManager.addLayer(layer, category, thisId, thisGroup, df.get(i, "ctGroup", true), df.g.length > 0) {
  ...
  var gjlayer = _leaflet2.default.geoJson(data, {
    style: function style(feature) {
      if (feature.style || feature.properties.style) {
        return _jquery2.deet(i, "ctKey", true));
        if (layer.bindPopup) {
          var popup = df.get(i, "popup");
          var popupOptions = df.get(i, "popupOptions");
          if (popup !== null) {
 ...
 */
methods.addPolylines = function (polygons, layerId, group, options, popup, popupOptions, label, labelOptions, highlightOptions) {
  if (polygonsfault.extend({}, globalStyle, feature.style, feature.properties.style);
      } else {
        return globalStyle;
      }
    },
...
methods.addLegend = function (options) {
  ...
  fault.extend({}, globalStyle, feature.style, feature.properties.style);
      } else {
        return globalStyle;
      }
    },
...
methods.getControl = function (layerId) {
  this.controls.get(l    if (options.na_color && _jquery2.default.inArray(options.na_label, labels) < 0) {
...
methods.addRasterImage = function (uri, bounds, opacity, attribution, layerId, group) {
  ...
  // These are the variables that we will populate once the image is loaded.
  var imgData = null; // 1d row-major array, four [0-255] integers per pixel
  var imgDa    if (options.na_color && _jquery2.default.inArray(options.na_label, labels) < 0) {
        colors.push(options.na_color);
        labels.push(options.na_label);
      }
      for (var i = 0; i < colors.length; i++) {
...
function setupShowHideGroupsOnZoom(map) {
  ...
  function showHideGroupsOnZoom() {
    ...
    var zoom = map.getZoom();
    map.layerManager.getAllGroupNames().forEachtaMipMapper = null;
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Const        // absolute coordinate to a width/height). Yes, I had to look
              // up minuend and subtrahend.
              Math.round(pixelPos.x + pixelSize.x) - Math.round(pixelPos.x), Math.round(pixelPos.y + pixelSize.y) - Math.round(pixelPos.y));
            }
          }
...
function ructor, staticProps); return Constructor; }; }();
